...
Original file is located at
    https://colab.research.google.com/drive/1aQpdd6m5LSD20rAj2XW142PGJ9LD_iGL
"""
...
$\color{blue}{\textit Your Answer:}$ No, it doesn't make sense.
...
for lr in lrs:
  for rs in regs:
    ...
    print('lr %e reg %e  val accuracy: %f' % (lr, rs, val_acc))
