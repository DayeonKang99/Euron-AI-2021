...
Original file is located at
    https://colab.research.google.com/drive/148SPX5A_wDOS1mZjoDDVFcU3wbLK_s-O
"""
...
def three_layer_convnet(x, params):
    ...
    #layer1 = F.relu(F.conv2d(x, conv_w1, conv_b1, padding=2))
    conv1 = F.conv2d(x, weight=conv_w1, bias=conv_b1, padding=2)
    relu1 = F.relu(conv1)

    #layer2 = F.relu(F.conv2d(layer1, conv_w2, conv_b2, padding=1))
...
**Answer:** (convolutional layer → batchnorm → relu → maxpoll → dropout) x 2 → (convolutional layer → batchnorm → relu → maxpoll) → fully connected layer <br>
tested learning rate 3 times (1e-2, 1e-3, 1e-4) best learning rate was 1e-3 <br>
